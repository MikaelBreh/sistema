...
from .models import Products, Clientes, Materiais_de_Trabalho, Fornecedores, Vendedores
from cadastros.cadastro_logica.estatico_dicionario_banco_titulos.dict_produtos_exibicao_em_lista import \
    dicionario_produtos, dicionario_clientes, dicionario_fornecedores, dicionario_materiais_de_trabalho, \
